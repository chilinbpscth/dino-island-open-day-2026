...
export function mountGame(root,zone,state,save,finish,lifecycle={}){
 if(['mandarin','computing','math','general','humanities','music','art','science'].includes(zone.id)){
  ...
  const mount={mandarin:mountMandarin,computing:mountComputing,math:mountMath,general:mountGeneral,humanities:mountHumanities,music:mountMusic,art:mountArt,science:mountScience}[zone.id];
