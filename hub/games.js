...
export function mountGame(root,zone,state,save,finish,lifecycle={}){
 if(['mandarin','computing','math','general'].includes(zone.id)){
  ...
  const mount={mandarin:mountMandarin,computing:mountComputing,math:mountMath,general:mountGeneral}[zone.id];
