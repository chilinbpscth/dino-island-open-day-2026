...
export function mountGeneral(root,state,save,finish){
 ...
 function render(){
  ...
  const pose={wake:'dino-waking',play:'dino-playing',bath:'dino-washing'}[action];
  if(pose)root.querySelector('.routine-dino .character').src=`img/games/general/${pose}.png`;
