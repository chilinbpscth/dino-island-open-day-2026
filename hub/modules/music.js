...
export function mountMusic(root,state,save,finish){
 ...
 return()=>{live=false;cancel();context?.close().catch(()=>{});document.removeEventListener('visibilitychange',background);delete root.dataset.guided;};
}
