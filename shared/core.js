...
export const ZONES=[
 ...
 ['math','數學','apple',null,'數清楚先餵。','份量啱啱好，小龍食得開心！出去可以真係餵大龍。'],
 ['general','常識','sun','xiaozhi-welcome','天氣唔同，照顧方法唔同。','晴天、雨天、凍天，小龍都有好好照顧！'],
 ['science','科學','search','xiaozhi-sit','先睇清楚，再決定點幫。','睇清楚需要，小龍精神返，學識健康生活！'],
 ['humanities','人文','share','xiaolian-point','分享同輪流，大家先開心。','大家都有水果，小龍學識分享同輪流！'],
 ['art','視藝','paint','xiaolian-color','揀啱色同形，幫小龍行返屋企。','彩色踏石鋪好，小龍安全過河返屋企！'],
